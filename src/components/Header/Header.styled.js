...
export const HeaderUserThemeText = styled.p`
color: #000;
  font-size: 14px;
  line-height: 21px;
  letter-spacing: -0.14px;
...
export const HeaderUserSetThemeInp = styled.input`
...
export const HeaderUserSetBtn = styled.button`
width: 72px;
  height: 30px;
...
export const HeaderUserSetText = styled.a`
color: #565EEF;
`;